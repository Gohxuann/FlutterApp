...
import 'package:mymembership_app/models/myevent.dart';
import 'package:mymembership_app/myconfig.dart';
import 'package:mymembership_app/views/events/edit_event.dart';
...
class _EventScreenState extends State<EventScreen> {
  ...
  void loadEventsData() {
    http
        .get(
            Uri.parse("${MyConfig.servername2}/membership/api/load_events.php"))
        .then((response) {
  ...
  void deleteNews(int index) {
    http.post(
        Uri.parse("${MyConfig.servername2}/membership/api/delete_event.php"),
        body: {
